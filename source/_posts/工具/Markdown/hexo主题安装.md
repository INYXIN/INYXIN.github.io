...
permalink: /post/fgke1014-1e8b-5gjn-8369-ec9a1a9a42c3/
---
`千里之行，始于足下。`

**hexo 安装参考** [文档 | Hexo](https://hexo.io/zh-cn/docs/index.html)



**hexo 主题安装** [Themes | Hexo](https://hexo.io/themes/)

前往主题网站 , 搜索主题 `fluid` , 可以预览 和前往 github 安装

![image-20240707152913095](hexo主题安装/image-20240707152913095.png)
...
![image-20240707153426510](hexo主题安装/image-20240707153426510.png)

修改`Hexo/_config`主题配置

```yml
theme: fluid
```

![image-20240707153713218](hexo主题安装/image-20240707153713218.png)

将 `Hexo/themes/fluid/_config`.yml 配置文件复制一份到 hexo 根目录 并命名为 `_config.fluid.yml`

![image-20240707153550259](hexo主题安装/image-20240707153550259.png)

这个 `_config.fluid.yml` 是用户对主题的配置, 优先级高于 默认主题 `_config` 

这个主题配置中有很多可配置项 , 请自行配置 
...
![image-20240707154309268](hexo主题安装/image-20240707154309268.png)

![image-20240707154325052](hexo主题安装/image-20240707154325052.png)
...
index:
  ...
  banner_img: /images/page-home.webp
...
#---------------------------
post:
  banner_img: /images/page-article.webp
...
#---------------------------
archive:
  banner_img: /images/page-archives.webp
...
category:
  enable: true
  banner_img: /images/page-categories.webp
  banner_img_height: 60
  banner_mask_alpha: 0.3
...
tag:
  enable: true
  banner_img: /images/page-tags.webp
...
about:
  enable: true
  banner_img: /images/page-about.webp
  banner_img_height: 60
  banner_mask_alpha: 0.3
  ...
  icons:
    ...
    - { class: "iconfont icon-gitee-fill", link: "https://gitee.com/inyxin/inyxin", tip: "Gitee" }
    - { class: "iconfont icon-qq-fill", qrcode: "/images/qrcode-qq.jpg"}
...
links:
  enable: true
  banner_img: /images/page-links.webp
  banner_img_height: 60
  banner_mask_alpha: 0.3
  # 友链的成员项
  # Member item of page
